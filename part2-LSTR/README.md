**LSTR**: Lane Shape Prediction with Transformers (manipulated for MMI702 course project.)
=======

## Legal Notice
=======
This repo originally belongs to [Ruijin Liu](https://github.com/liuruijin17/LSTR). For academic purposes, I have just forked the repo and manipulated the code in order to test it on private dataset.
...
*    Writing apropriate dataloader for the project.
*    Infering already available model with the publicly-not-available dataset. 
*    Re-training the model with publicly-not-available dataset for different epochs and different input sizes.
*    Iterating this loop for different hyoer parameters.
*    Manipulated the model for better result on publicly-not-available dataset.
*    For detailed explanation please contact [me](mailto: aytekin.erdogan@metu.edu.tr)


_____________________________________________________________________________

***Original Repo Starts here.***
